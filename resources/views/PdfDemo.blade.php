...
<p style="border-top: 1px solid #a42600"><span style="color:#a42600; font-size: 0.8em">{{ $project['name'] }} </span><span style="color:#a42600; font-size: 0.6em">- {{ $project['street'] }} {{ $project['housenumber'] }}, {{ $project['postcode'] }} {{ $project['city'] }}</span><br><span style="color:grey; font-size: 1.4em">{{ $visit['title'] }}, {{ $visit['date'] }}</span>
</p>
