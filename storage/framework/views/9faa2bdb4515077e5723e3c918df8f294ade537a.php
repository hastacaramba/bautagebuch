<!-- HEAD [start] -->
<?php $__env->startComponent('partials.head'); ?>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- SIDEBAR [start] -->
    <?php $__env->startComponent('partials.sidebar'); ?>
      <strong>Whoops!</strong> Something went wrong!
    <?php echo $__env->renderComponent(); ?>
    <!-- SIDEBAR [end] -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <?php $__env->startComponent('partials.topbar'); ?>
          <strong>Whoops!</strong> Something went wrong!
        <?php echo $__env->renderComponent(); ?>
        <!-- End of Topbar -->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-10">
                <div>
                    <a href="/bauprojekte">Bauprojekte</a> / <a href="/projects/<?php echo e($project->id); ?>"><?php echo e($project->number); ?> <?php echo e($project->name); ?></a>
                </div>
                <h2 class="m-0 font-weight-bold text-primary">Begehung: <?php echo e($visit->title); ?>, <?php echo e(date('d.m.Y', strtotime($visit->date))); ?></h2>
            </div>
          ...
          <div class="card-body">
              <div class="row mb-3">
                  <div class="col-md-9">
                      ...
                      <input id="title" type="text" style="width:100%; color:#6e707e" value="<?php echo e($visit->title); ?>" placeholder="Bezeichnung...">
                  </div>
                  <div class="col-md-3">
                      <label>Bauleiter</label><br>
                      <select id="responsible">
                          <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user->id); ?>" <?php if($user->id == $visit->user_id): ?> selected="selected" <?php endif; ?>><?php echo e($user->name); ?></option>
              ...
              <div class="row mb-3">
                  <div class="col-md-3">
                      ...
                      <input id="date" type="text" style="width:100%; color:#6e707e" value="<?php echo e($visit->date); ?>" placeholder="Datum...">
                  </div>
                  <div class="col-md-3">
                      <label>Uhrzeit</label><br>
                      <input id="time" type="text" style="width:100%; color:#6e707e" value="<?php echo e($visit->time); ?>" placeholder="Uhrzeit...">
                  </div>
                  <div class="col-md-6">
                      <label>Wetter</label><br>
                      <input id="weather" type="text" style="width:100%; color:#6e707e" value="<?php echo e($visit->weather); ?>" placeholder="Wetter...">
                  </div>
              </div>
              <div class="row">
                  <div class="col-md-12">
                      <label for="visitDescription">Baufortschritt</label>
                      <textarea rows="5" type="text" class="form-control" id="visitDescription"><?php echo e($visit->description); ?></textarea>
                  </div>
              </div>
                  ...
                  <div class="card-body">
                      ...
                      <div id="chooseNewVisitMedia" style="display:none">
                          <div class="form-group">
                              <form id="newVisitMediaForm" action="<?php echo e(route('image.upload.post.visit')); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="table-responsive">
                          <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/visit/<?php echo e($visit->id); ?>/media"
                                  data-search="true"
                  ...
                  <div class="card-body">
                      ...
                      <div class="table-responsive">
                          <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/visit/<?php echo e($visit->id); ?>/presence"
                                  data-search="true"
                                  data-show-columns="false"
                                  data-pagination="true"
                                  data-page-list="[10, 25, 50, 100, ALL]"
                  ...
                  <div class="card-body">
                      <div class="table-responsive">
                          ...
                          <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/visitationnotes/<?php echo e($visit->id); ?>"
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                      ...
                      <div id="chooseNewVisitMediaPdf" style="display:none">
                          <div class="form-group">
                              <form id="newVisitMediaFormPdf" action="<?php echo e(route('pdf.upload.post.visit')); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="table-responsive">
                          <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/visit/<?php echo e($visit->id); ?>/pdf"
                                  data-search="true"
                                  data-show-columns="false"
                                  data-pagination="true"
                                  data-page-list="[10, 25, 50, 100, ALL]"
                  ...
                  <div class="card-body">
                      <div class="table-responsive">
                          ...
                          <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/reports/<?php echo e($visit->id); ?>"
                                  data-search="true"
      ...
      <?php $__env->startComponent('partials.footer'); ?>
        <strong>Whoops!</strong> Something went wrong!
      <?php echo $__env->renderComponent(); ?>
                  ...
                  <div class="modal-footer mt-4">
                      ...
                      <div class="table-responsive">
                          ...
                          <div id="chooseNewMedia">
                              <div class="form-group">
                                  <form id="newForm" action="<?php echo e(route('image.upload.post')); ?>" method="POST" enctype="multipart/form-data">
                                      <label for="image">Foto hochladen</label>
                                      <div class="row">
                                          <div class="col-md-9">
                                              <input type="file" id="image" name="image" class="form-control">
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <form id ="editVisitMediaForm" action="<?php echo e(route('image.upload.post.edited.visit')); ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      <form id ="editVisitMediaFormPdf" action="<?php echo e(route('pdf.upload.post.edited.visit')); ?>" method="POST" enctype="multipart/form-data">
  ...
  <script>
      ...
      $("#pdfTest").click(function () {
          ...
          var idString = $.now().toString() + '<?php echo e(Auth::user()->id); ?>';
  ...
  <script>
      ...
      function handleClick(cb, id) {
          ...
          $.ajax({
              type: "PATCH",
              url: "/visit/<?php echo e($visit->id); ?>/presence",
              data:
                  {
                      'memberID' : id,
                      'presence' : checked
      ...
      function handleSubscribeClick(cb, id) {
          ...
          $.ajax({
              type: "PATCH",
              url: "/visit/<?php echo e($visit->id); ?>/subscribe",
              data:
                  {
                      'memberID' : id,
                      'subscribe' : checked
      ...
      function pdfFormatter(value, row, index) {
          var url = "<?php echo e(url('/storage/app/public/documents')); ?>/" + value;
      ...
      function operateFormatterReports(value, row, index) {
          var url = "<?php echo e(url('/storage/app/public/reports/')); ?>/" + row.filename;
          return [
      ...
      function filenameFormatterReports(value, row, index) {
          var url = "<?php echo e(url('/storage/app/public/reports/')); ?>/" + value;
  ...
  <script>
      ...
      $(document).ready(function () {
          ...
          $("#newVisitMediaForm").submit(function(e) {
              ...
              visitMediaFormData.append('visitID', '<?php echo e($visit->id); ?>');
          ...
          $("#editVisitMediaForm").submit(function(e) {
              ...
              editVisitMediaFormData.append('visitID', '<?php echo e($visit->id); ?>');
          ...
          $("#newVisitMediaFormPdf").submit(function(e) {
              ...
              visitMediaFormPdfData.append('visitID', '<?php echo e($visit->id); ?>');
          ...
          $("#editVisitMediaFormPdf").submit(function(e) {
              ...
              editVisitMediaFormPdfData.append('visitID', '<?php echo e($visit->id); ?>');
...
<?php /**PATH /www/htdocs/w019e95a/bautagebuch/resources/views/visit.blade.php ENDPATH**/ ?>