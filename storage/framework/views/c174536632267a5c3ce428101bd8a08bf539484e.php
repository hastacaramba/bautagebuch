...
<body id="page-top">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-10">
                        <div>
                            <a href="/bauprojekte">Bauprojekte</a> / <a href="/projects/<?php echo e($projectID); ?>"><?php echo e($number); ?> <?php echo e($name); ?></a>
                        </div>
                        <h2 class="m-0 font-weight-bold text-primary">Bauprojekt: <?php echo e($number); ?> <?php echo e($name); ?></h2>
                        <div class="border-left-primary pl-2 text-primary mb-2">
                            <?php echo e($street); ?> <?php echo e($housenumber); ?>, <?php echo e($postcode); ?> <?php echo e($city); ?><br>
                            Erstellt: <?php echo e(date('d.m.Y', strtotime($created_at))); ?><br>
                            Letzte Aktualisierung: <?php echo e(date('d.m.Y', strtotime($updated_at))); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <img class="img-fluid img-rounded" src="/images/<?php echo e($photo); ?>">
                    </div>
                </div>
            </div>
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table
                                  ...
                                  data-toggle="table"
                                  data-sortable="true"
                                  data-url="/members/<?php echo e($projectID); ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table
                              ...
                              data-toggle="table"
                              data-sortable="true"
                              data-url="/visits/<?php echo e($projectID); ?>"
  ...
  <script>
    ...
    $("#pdfTest").click(function () {
        ...
        var id = $.now().toString() + '<?php echo e(Auth::user()->id); ?>';
    ...
    $("#btnNewVisit").click(function (e) {
        $.ajax({
            type: "POST",
            url: "/visit/new/<?php echo e($projectID); ?>",
            data: {
...
<?php /**PATH /www/htdocs/w019e95a/bautagebuch/resources/views/project.blade.php ENDPATH**/ ?>