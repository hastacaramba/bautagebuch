...
<body id="page-top">
  ...
  <!-- Logout Modal [start] -->
  <?php $__env->startComponent('partials.logoutModal'); ?>
    <strong>Whoops!</strong> Something went wrong!
  <?php echo $__env->renderComponent(); ?>
  <!-- Logout Modal [end] -->
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <form id ="editForm" action="<?php echo e(route('image.upload.post')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /**PATH /www/htdocs/w019e95a/bautagebuch/resources/views/bauprojekte.blade.php ENDPATH**/ ?>